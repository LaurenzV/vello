...
fn main() {
    ...
    let a = PremulColor::from_alpha_color(ROYAL_BLUE).as_premul_rgba8().to_u8_array();
    let a_f32_4 = PremulColor::from_alpha_color(ROYAL_BLUE).as_premul_f32().components;
    let a_f32_16 = [
        a_f32_4[0], a_f32_4[1], a_f32_4[2], a_f32_4[3],
        a_f32_4[0], a_f32_4[1], a_f32_4[2], a_f32_4[3],
        a_f32_4[0], a_f32_4[1], a_f32_4[2], a_f32_4[3],
        a_f32_4[0], a_f32_4[1], a_f32_4[2], a_f32_4[3],
    ];
